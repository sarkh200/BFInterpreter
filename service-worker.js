import { config } from "./package_8124a0496b136d4d7195ed07998eff1929b8eaad/uno-config.js";
...
if (config.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('package_8124a0496b136d4d7195ed07998eff1929b8eaad').then(async function (cache) {
